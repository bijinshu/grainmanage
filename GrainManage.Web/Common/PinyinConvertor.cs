...
namespace GrainManage.Web.Common
{
    ...
    public class PinyinConvertor
    {
        ...
        ///完成于：
        /// </summary> 
        //static Regex MyRegex = new Regex("^[一-龥]$"); 
...
"zi","zong","zou","zu","zuan","zui","zun","zuo"};
        ...
        public static string ConvertAllSpell(string chrstr)
        {
            ...
            for (int j = 0; j < nowchar.Length; j++)
            {
                ...
                {
                    array = Encoding.UTF8.GetBytes(nowchar[j].ToString());
                    i1 = (short)(array[0]);
                    i2 = (short)(array[1]);
        ...
        public static string GetChineseSpell(string strText)
        {
            ...
            for (int i = 0; i < len; i++)
            {
                myStr += GetFirstWordSpell(strText.Substring(i, 1));
            }
            return myStr;
        }
        ...
        /// <returns></returns>
        public static string GetFirstWordSpell(string cnChar)
        {
            byte[] arrCN = Encoding.UTF8.GetBytes(cnChar);
            if (arrCN.Length > 1)
            {
